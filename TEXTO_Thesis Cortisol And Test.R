...
Datos_Cort_Pre <-  read_excel("D:/Documentos/4. Labs/Seminario Ana/1. Papit/TESIS/Datos/Cortisol/Analisis_Cortisol.xlsx", sheet = 2)
Datos_Cort_Pos <-  read_excel("D:/Documentos/4. Labs/Seminario Ana/1. Papit/TESIS/Datos/Cortisol/Analisis_Cortisol.xlsx", sheet = 3)

Datos_CAR <- read_excel ("D:/Documentos/4. Labs/Seminario Ana/1. Papit/TESIS/Datos/Cortisol/Datos_CAR.xlsx")
Datos_CAR_Pre <- select(Datos_CAR, -4,-5,-6)
Datos_CAR_Pos <- select(Datos_CAR, -1,-2,-3)

#Data Test

Datos_Test_Pre <- read_excel("D:/Documentos/4. Labs/Seminario Ana/1. Papit/TESIS/Datos/Test_PrePost_AQ_DASS.xlsx",sheet = "PRE")
Datos_Test_Pos <- read_excel("D:/Documentos/4. Labs/Seminario Ana/1. Papit/TESIS/Datos/Test_PrePost_AQ_DASS.xlsx",sheet = 3)
...
#Correlations with Psychometric Data and Cortisol Pre

library(metan)

#PRE

Cort_Test_Pre <- corr_coef(D_Cort_Test_Pre[,-1])
plot(Cort_Test_Pre) 

CAR_Test_Pre <- corr_coef(D_CAR_Test_Pre[,-1])
plot(CAR_Test_Pre)


#Filtered Correlations PRE
...
Cort_Test_Pre_F <- corr_coef(D_Cort_Test_Pre_F[,-1])
plot(Cort_Test_Pre_F)
...
CAR_Test_Pre_F <- corr_coef(D_CAR_Test_Pre_F[,-1])
plot(CAR_Test_Pre_F)


#POS

Cort_Test_Pos <- corr_coef(D_Cort_Test_Pos[,-1])
plot(Cort_Test_Pos)

CAR_Test_Pos <- corr_coef(D_CAR_Test_Pos[,-1])
plot(CAR_Test_Pos)    ###There is no relation between CAR and test in the POS###


#Filtered Correlations POS
...
Cort_Test_Pos_F <- corr_coef(D_Cort_Test_Pos_F[,-1])
plot(Cort_Test_Pos_F)

#Clean environment 

rm(Cort_Test_Pre, CAR_Test_Pre, Cort_Test_Pre_F, CAR_Test_Pre_F, Cort_Test_Pos, CAR_Test_Pos, Cort_Test_Pos_F)  

#Models Linear Regression = Aggressive ~ CORTISOL + Psychometric
...
rm(Mod_AQfis_Cort_F, Mod_AQIra, ModA_AQ_TOTAL, ModC_AQ_TOTAL, ModD_AQ_FIS)
rm(D_CAR_Test_Pre,D_CAR_Test_Pre_F, D_Cort_Test_Pos_F, D_Cort_Test_Pre_F)
